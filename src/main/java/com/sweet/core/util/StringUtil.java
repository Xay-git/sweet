...
public class StringUtil {
	 ...
	 */
	public static Map<String, String> getBirAgeSexByIdCard(String certificateNo) {
		String birthday = "";
		String age = "";
		String sexCode = "";
		...
		if (flag && certificateNo.length() == 15) {
			...
			sexCode = Integer.parseInt(certificateNo.substring(certificateNo.length() - 3, certificateNo.length())) % 2 == 0 ? "FEMALE" : "MALE";
			age = (year - Integer.parseInt("19" + certificateNo.substring(6, 8))) + "";
		} else if (flag && certificateNo.length() == 18) {
			birthday = certificateNo.substring(6, 10) + "-"
					+ certificateNo.substring(10, 12) + "-"
					+ certificateNo.substring(12, 14);
			sexCode = Integer.parseInt(certificateNo.substring(certificateNo.length() - 4, certificateNo.length() - 1)) % 2 == 0 ? "FEMALE" : "MALE";
