package com.sweet.modular.wx.wxconst;

public class ResponseConst {

    public static final String DEFAULE_TEXT = "又是一个阳光明媚的一天！棒笛真棒！\uD83D\uDC4D";
    ...
    public static final String SET_KEYWORD_CONFIG_FAILURE = "⛔设置指令不正确哦！指令如下：\n\n关键词：周杰伦\n";
